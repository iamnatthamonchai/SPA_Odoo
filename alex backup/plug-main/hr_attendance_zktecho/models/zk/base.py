...
class ZK(object):
    ...
    def get_attendance(self):
        ...
        if self.records == 0: #lazy
            return []
        users = self.get_users()
        print(users,"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
        ...
        print(attendance_data,"ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd")
        if record_size == 8 : #ultra old format
            while len(attendance_data) >= 8:#TODO RETEST ZK6!!!
                ...
                print(punch,"sagarrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr")
            ...
            while len(attendance_data) >= 16: #TODO RETEST ZK6
                ...
                attendances.append(attendance)
                print(punch,"harshitttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt")
        else:
            while len(attendance_data) >= 40:
                ...
                print(punch,"yashassssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss")
        return attendances
