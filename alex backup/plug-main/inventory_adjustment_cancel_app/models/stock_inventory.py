        ...
        for move in moves:
            ...
            if move.location_dest_id.usage == 'inventory' :
                if move.product_id.tracking == 'none':
                    quant = self.search([('product_id','=',move.product_id.id),('location_id','=',move.location_id.id),('lot_id','=',lot_id.id)],limit=1)
                ...
                if move.product_id.tracking == 'none':
                    quant = self.search([('product_id','=',move.product_id.id),('location_id','=',move.location_dest_id.id),('lot_id','=',lot_id.id)],limit=1)
