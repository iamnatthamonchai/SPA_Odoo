odoo.define('sh_inventory_barcode_mobile.notification_manager', function (require) {
    "use strict";

    var AbstractService = require('web.AbstractService');
    var core = require("web.core");

    var sh_inventory_barcode_mobile_notification_manager = AbstractService.extend({
                ...
                if (type === "sh_inventory_barcode_mobile_notification_info") {
                    ...
                    if (payload.message) {
                        ...
                        if (str_msg) {
                            ...
                            //play sound
                            var src = "/sh_inventory_barcode_mobile/static/src/sounds/picked.wav";
                        ...
                        if (str_msg) {
                            ...
                            //play sound
                            var src = "/sh_inventory_barcode_mobile/static/src/sounds/error.wav";
                            $("body").append('<audio src="' + src + '" autoplay="true"></audio>');
                        }
                        //for play sound ends here  
    ...
    core.serviceRegistry.add('sh_inventory_barcode_mobile_notification_manager', sh_inventory_barcode_mobile_notification_manager);

    return sh_inventory_barcode_mobile_notification_manager;
