            ...
            async _clickProduct(event) {
                ...
                if (this.env.pos.config.enable_product_bundle && product.sh_is_bundle) {
                    ...
                    $.each(bundle_by_product_id, function (key, value) {
                        ...
                        table_html += '<td class="data_td"><input type="hidden" class="hidden_qty" value="' + value[1] + '"/><input type="text" readonly="1" class="qty_input" value="' + value[1] + '"/></td><td class="data_td">' + value[2][1] + "</td>";
                        table_html += "</tr>";
                        count += 1;
                    });
            ...
            _setValue(val) {
                if (this.currentOrder.get_selected_orderline()) {
                    if (this.state.numpadMode === "quantity") {
                        ...
                        if (selected_orderline.get_current_uom() && selected_orderline.get_unit() != selected_orderline.get_current_uom()){
                            var converted_qty1 = selected_orderline.convert_qty_uom(1, selected_orderline.get_current_uom(), selected_orderline.get_unit());
                            
                            selected_orderline.set_unit_price(converted_qty1 * parseFloat(val));
                            selected_orderline.update_unit_price = val
                        }else{
