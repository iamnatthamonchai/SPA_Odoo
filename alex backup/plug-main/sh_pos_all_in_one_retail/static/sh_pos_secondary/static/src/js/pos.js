odoo.define("sh_pos_secondary.screens", function (require) {
    ...
    models.Orderline = models.Orderline.extend({
        ...
        get_display_product_unit_price() {
            ...
            if (this.update_unit_price && this.update_unit_price == value){
                this.update_unit_price = value;
            }
            return this.pos.format_currency(this.update_unit_price || value)
        },
